...
func init() {
	...
	addCountFlag(meditationCmd, &meditationCount)
...
func meditationSimulate(cmd *cobra.Command, args []string) error {
	...
	return generateSeries(meditationDatetime, meditationFile, meditationCount, func(startTime time.Time, outFile string) error {
